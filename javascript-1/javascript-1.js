...
//CODE HERE
let n = lettersToPair.length; 
let arr = lettersToPair
...
// let fidoIntro = fido.dogIntro.apply(fido, ['chicken', 'tennis ball']);  
...
//CODE HERE
  let phone1 = new Phone('apple', 'x', 64, 'silver', false);
  
  let phone2 = new Phone('samsung', 'galaxy', 128, 'rose gold', false);
  
  let phone3 = new Phone('LG', 'touch', 64, 'black', false);
...
let index = this.sold.findIndex( element => element === false)
this.sold.splice(index,1,true);
